...
> **Note (2026-02-01):** This document is a historical snapshot. Archive-Hasher has been removed from the project scope. See the current [README.md](../README.md) and [Architecture.md](Architecture.md) for up-to-date information.
